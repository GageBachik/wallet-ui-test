...
export const Button = (props) => {
    ...
    return (React.createElement("button", { className: `${props.className || ''}`, disabled: props.disabled, onClick: props.onClick, style: Object.assign({ justifyContent }, props.style), tabIndex: props.tabIndex || 0 },
